...
def prediction_plot(time_step, num_day_shown, data):
   ...
   trace.add_scatter(x= modeled_data['date'], y= modeled_data['valid_pred'], name= f'Valid prediction<br>Root mean square error: {rmse}<br>Mean square error: {mse}<br>Mean absolute error: {mae}<br>Explained variance score: {evs}<br>R2 score: {r2s}')
